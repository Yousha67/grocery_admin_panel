...
import 'package:image_picker/image_picker.dart' as pb;
...
class _UploadProductFormState extends State<UploadProductForm> {
  ...
  Future<void> _pickImage() async {
    if (!kIsWeb) {
      final pb.ImagePicker _picker = pb.ImagePicker();
      XFile? image = await _picker.pickImage(source: pb.ImageSource.gallery);
      if (image != null) {
